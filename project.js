$(document).ready(function() {
    ...
    $("button").on("click", function() { // Run when user hits Enter or Tab in Zip Code Box
        ...
        var locationKeyUrl = "https://dataservice.accuweather.com/locations/v1/postalcodes/search?apikey=tOVMbQyaHspFKcQVLGhRdx1Af0VwV6e7&q=" + zipcode;
        ...
        $.getJSON(locationKeyUrl, function(data) {
            ...
            var weatherForecastUrl = "https://dataservice.accuweather.com/forecasts/v1/daily/1day/" + locationKey + "?apikey=tOVMbQyaHspFKcQVLGhRdx1Af0VwV6e7&details=true&metric=false";
